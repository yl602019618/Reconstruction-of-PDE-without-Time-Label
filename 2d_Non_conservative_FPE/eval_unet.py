...
from NIOModules import PermInvUNet_attn  # make sure this is importable
...
DEFAULT_CKPT   = "/home/ubuntu/unlabelPDE_official/2d_force/result_unet/model_checkpoint_best_0.044678.pt"
DEFAULT_OUTDIR = "result_fig/unet"
...
def main():
    ...
    model = PermInvUNet_attn(in_ch=1, out_ch=2, base_ch=1, depth=5, input_size=(args.nx, args.ny))
    ...
    with open(metrics_path, "a", newline="") as f_csv:
        ...
        for idx in range(args.start, args.end + 1):
            ...
            with torch.no_grad():
                ...
                pred = model(x)  # expect (B, Nx, Ny, 2) or (B, 2, Nx, Ny)
