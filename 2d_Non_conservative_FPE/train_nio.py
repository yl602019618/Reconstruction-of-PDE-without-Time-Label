...
num_epochs = 400
save_interval = 5
os.makedirs("result_2d_nio", exist_ok=True)
train_losses = []
test_losses = []
test_losses_drift = []
...
for epoch in range(1, num_epochs + 1):
    ...
    if epoch % save_interval == 0:
        ...
        if accelerator.is_local_main_process:
            ...
            plt.yscale('log')
            plt.grid(True)
            plt.savefig(f"result_2d_nio/loss_curve.png")
            plt.close()
            ...
            if test_loss < best_test_loss:
                ...
                best_ckpt_path = f"result_2d_nio/model_checkpoint_best_{best_test_loss:.6f}.pt"
            ...
            plt.savefig(f"result_2d_nio/F_epoch_{epoch}.png")
            plt.close()
            
np.save("result_2d_nio/train_losses.npy", np.array(train_losses))
np.save("result_2d_nio/test_losses.npy", np.array(test_losses))
np.save("result_2d_nio/test_losses_drift.npy", np.array(test_losses_drift))
np.save("result_2d_nio/test_losses_diffusion.npy", np.array(test_losses_diffusion))