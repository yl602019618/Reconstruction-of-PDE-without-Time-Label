...
ckpt_path  = "/home/ubuntu/unlabel_PDE_official/1d/results_unet_bag/model_checkpoint_best_0.240148.pt"

save_dir = "result_fig/unet"
...
def load_model(device):
    # 与训练时参数保持一致
    model = PermInvUNet_attn1D_bag(in_ch=1, out_ch=2, base_ch=1, depth=4, input_size=80,device = device).to(device)
    return model
