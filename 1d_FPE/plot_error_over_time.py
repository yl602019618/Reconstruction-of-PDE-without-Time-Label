...
# 路径
# ----------------------------
pt_ref_path = "/home/ubuntu/unlabel_PDE_official/1d/result_fig/Pt.npy"
pt_blindno_path = "/home/ubuntu/unlabel_PDE_official/1d/result_fig/unet/Pt.npy"
pt_nio_path  = "/home/ubuntu/unlabel_PDE_official/1d/result_fig/nio/Pt.npy"
pt_fno_path  = "/home/ubuntu/unlabel_PDE_official/1d/result_fig/fno/Pt.npy"

# ----------------------------
# 加载数据
# 期望形状 (T, Nx) = (400, 80)
# ----------------------------
Pt_ref  = np.load(pt_ref_path)   # (400, 80)
Pt_blindno = np.load(pt_blindno_path)  # (400, 80)
Pt_nio  = np.load(pt_nio_path)   # (400, 80)
Pt_fno  = np.load(pt_fno_path)   # (400, 80)
...
def relative_l2_over_time(P_model, P_ref, eps=eps):
    # (T, Nx)
    num = np.linalg.norm(P_model - P_ref, axis=1, ord=2)
    den = np.linalg.norm(P_ref, axis=1, ord=2) + eps
    return num / den  # (T,)
