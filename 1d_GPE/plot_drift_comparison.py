...
# ========= 读入数据（按你的路径） =========
U_gt = np.load('/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/unet/sample_pred_V.npy',allow_pickle = True).item()["true_V"]

U_BlinDNO = np.load('/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/unet/sample_pred_V.npy',allow_pickle = True).item()["pred_V"]




U_nio = np.load('/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/nio/sample_pred_V.npy',allow_pickle = True).item()["pred_V"]

U_fno = np.load('/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/fno/sample_pred_V.npy',allow_pickle = True).item()["pred_V"]
...
plt.savefig("V_compare_schrodinger.pdf", dpi=300)
plt.close(fig)
