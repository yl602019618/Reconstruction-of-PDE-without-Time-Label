...
CKPT_PATH  = "/home/ubuntu/unlabel_PDE_official/1dGPE/results_schrodinger_unet/model_checkpoint_best_0.038187.pt"

OUT_DIR    = "result_fig/unet"
...
def build_model(device):
    ...
    model = PermInvUNet_attn1D_bag(
        in_ch=1,
        out_ch=2,      # 与训练脚本一致（训练中 targets 只有 V 通道，但 out_ch 设为 2；保持完全一致以避免维度不匹配）
        base_ch=1,
        depth=4,
        input_size=128,
        device=device
