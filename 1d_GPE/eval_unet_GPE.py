...
CKPT_PATH  = "/home/ubuntu/unlabel_PDE_official/1dGPE/results_GPE_unet/model_checkpoint_best_0.027363.pt"

OUT_DIR    = "result_fig_GPE/unet"
os.makedirs(OUT_DIR, exist_ok=True)

# ====== 导入模型定义 ======
# 确保 NIOModules 在可导入路径中
from NIOModules import PermInvUNet_attn1D_bag_GPE  # 与训练时一致
