...
# -----------------------------
def generate_and_save_training_data(V = None, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path="training_data.npy"):
    """
    ...
    plt.subplot(1, 2, 2)
    im = plt.imshow(psi_abs,  aspect='auto', cmap='viridis')
    plt.xlabel("x")
    plt.ylabel("t")
...
if __name__ == '__main__':
    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/unet/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['true_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)

    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/unet/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/unet/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)
    
    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/nio/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/nio/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)

    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/fno/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig_GPE/fno/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)
