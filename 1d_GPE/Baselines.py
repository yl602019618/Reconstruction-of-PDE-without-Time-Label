...
class Encoder(nn.Module):
    def __init__(self, output_dim, dim1=64, dim2=128, dim3=256):
        ...
        self.final_conv3 = ConvBlock(dim3, dim3, kernel_size=(1, 7), stride=(1, 1), padding=(0, 0))
        self.final_conv4 = ConvBlock(dim3, dim3, kernel_size=(1, 4), stride=(1, 1), padding=(0, 0))
