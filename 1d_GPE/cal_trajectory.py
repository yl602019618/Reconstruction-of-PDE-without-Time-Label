...
if __name__ == '__main__':
    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/unet/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/traj.npy'
    ...
    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/unet/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/unet/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)
    
    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/nio/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/nio/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)

    data_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/fno/sample_pred_V.npy'
    save_path = '/home/ubuntu/unlabel_PDE_official/1dGPE/result_fig/fno/traj.npy'
    data = np.load(data_path, allow_pickle=True).item()
    V = data['pred_V']
    data_dict = generate_and_save_training_data(V = V, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path=save_path)
