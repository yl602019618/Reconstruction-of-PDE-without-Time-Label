...
if __name__ == '__main__':
    ...
    # 生成数据并保存
    data_dict = generate_and_save_training_data(num_orbits=1200, Nx=128, dt=0.005, t_final=5.0, order=2, num_time_samples=100, save_path="test_data_Schrodinger.npy")
