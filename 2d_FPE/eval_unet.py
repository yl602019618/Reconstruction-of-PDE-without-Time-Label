...
from NIOModules import PermInvUNet_attn  # ensure module is importable
...
DEFAULT_CKPT  = "/home/ubuntu/unlabelPDE_official/2d_diffusion/result_unet/model_checkpoint_best_0.038817.pt"
...
def main():
    ...
    model = PermInvUNet_attn(in_ch=1, out_ch=2, base_ch=1, depth=4, input_size=(args.nx, args.ny))
    ...
    with open(metrics_path, "a", newline="") as f_csv:
        ...
        for idx in range(args.start, args.end + 1):
            ...
            with torch.no_grad():
                ...
                pred = model(x)  # (B, 2, Nx, Ny) or (B, Nx, Ny, 2)
